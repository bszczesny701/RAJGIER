...
const PEOPLE = [
  ...
  { name: 'PAUL MCCARTNEY', age: '82 lata', nationality: 'Wielka Brytania', knownFor: 'Muzyk The Beatles' },
  { name: 'RINGO STARR', age: '84 lata', nationality: 'Wielka Brytania', knownFor: 'Muzyk The Beatles' },
  { name: 'KURT COBAIN', age: '1967–1994', nationality: 'USA', knownFor: 'Muzyk Nirvana' },
  { name: 'AMY WINEHOUSE', age: '1983–2011', nationality: 'Wielka Brytania', knownFor: 'Piosenkarka' },
  { name: 'FRANK SINATRA', age: '1915–1998', nationality: 'USA', knownFor: 'Piosenkarz' },
  { name: 'ARETHA FRANKLIN', age: '1942–2018', nationality: 'USA', knownFor: 'Piosenkarka' },
  { name: 'STEVIE WONDER', age: '74 lata', nationality: 'USA', knownFor: 'Muzyk' },
  { name: 'JUSTIN BIEBER', age: '30 lat', nationality: 'Kanada', knownFor: 'Piosenkarz' },
  { name: 'ARIANA GRANDE', age: '31 lat', nationality: 'USA', knownFor: 'Piosenkarka' },
  { name: 'DUA LIPA', age: '29 lat', nationality: 'Wielka Brytania', knownFor: 'Piosenkarka' },
  { name: 'THE WEEKND', age: '34 lata', nationality: 'Kanada', knownFor: 'Piosenkarz' },
  { name: 'POST MALONE', age: '29 lat', nationality: 'USA', knownFor: 'Raper' },
  { name: 'SZA', age: '35 lat', nationality: 'USA', knownFor: 'Piosenkarka' },
  { name: 'KENDRICK LAMAR', age: '37 lat', nationality: 'USA', knownFor: 'Raper' },
  { name: 'JAY-Z', age: '55 lat', nationality: 'USA', knownFor: 'Raper' },
  { name: 'NICKI MINAJ', age: '42 lata', nationality: 'Trinidad', knownFor: 'Raperka' },
  { name: 'COLDPLAY', age: 'zespół', nationality: 'Wielka Brytania', knownFor: 'Zespół rockowy' },
  { name: 'QUEEN', age: 'zespół', nationality: 'Wielka Brytania', knownFor: 'Zespół rockowy' },
  { name: 'METALLICA', age: 'zespół', nationality: 'USA', knownFor: 'Zespół metalowy' },
  { name: 'KAYAH', age: '54 lata', nationality: 'Polska', knownFor: 'Piosenkarka' },
  { name: 'NATALIA KUKULSKA', age: '48 lat', nationality: 'Polska', knownFor: 'Piosenkarka' },
  { name: 'MUNIEK STASZCZYK', age: '63 lata', nationality: 'Polska', knownFor: 'Muzyk T.Love' },
  { name: 'KULT', age: 'zespół', nationality: 'Polska', knownFor: 'Zespół rockowy' },
  { name: 'DONALD TUSK', age: '67 lat', nationality: 'Polska', knownFor: 'Polityk' },
  { name: 'ANDRZEJ DUDA', age: '52 lata', nationality: 'Polska', knownFor: 'Prezydent' },
  { name: 'JAROSŁAW KACZYŃSKI', age: '75 lat', nationality: 'Polska', knownFor: 'Polityk' },
  { name: 'ANNA GERMAN', age: '1946–1982', nationality: 'Polska', knownFor: 'Piosenkarka' },
  { name: 'CZESŁAW NIEMEN', age: '1939–2004', nationality: 'Polska', knownFor: 'Piosenkarz' },
  { name: 'MARYLA RODOWICZ', age: '74 lata', nationality: 'Polska', knownFor: 'Piosenkarka' },
  { name: 'EDYTA GÓRNIAK', age: '52 lata', nationality: 'Polska', knownFor: 'Piosenkarka' },
  { name: 'MICHAŁ WIŚNIOWSKI', age: '52 lata', nationality: 'Polska', knownFor: 'Komik' },
  { name: 'WOJCIECH MALAJKAT', age: '47 lat', nationality: 'Polska', knownFor: 'Aktor' },
  { name: 'MACIEJ MUSIAL', age: '27 lat', nationality: 'Polska', knownFor: 'Aktor' },
  { name: 'JULIA WIĘCKOWSKA', age: '26 lat', nationality: 'Polska', knownFor: 'Aktorka' },
  { name: 'KATARZYNA FIGURA', age: '62 lata', nationality: 'Polska', knownFor: 'Aktorka' },
  { name: 'DANUTA STENKA', age: '59 lat', nationality: 'Polska', knownFor: 'Aktorka' },
  { name: 'BOGUSŁAW LINDA', age: '72 lata', nationality: 'Polska', knownFor: 'Aktor' },
  { name: 'ZBIGNIEW CYBULSKI', age: '1927–1967', nationality: 'Polska', knownFor: 'Aktor' },
  { name: 'JERZY STUHR', age: '78 lat', nationality: 'Polska', knownFor: 'Aktor' },
  { name: 'KRYSTYNA JANDA', age: '71 lat', nationality: 'Polska', knownFor: 'Aktorka' },
  { name: 'OLAF LUBASZENKO', age: '52 lata', nationality: 'Polska', knownFor: 'Aktor' },
  { name: 'CEZARY PAZURA', age: '58 lat', nationality: 'Polska', knownFor: 'Aktor' },
  { name: 'BORYS SZYC', age: '47 lat', nationality: 'Polska', knownFor: 'Aktor' },
  { name: 'TOMASZ KOT', age: '48 lat', nationality: 'Polska', knownFor: 'Aktor' },
  { name: 'ADRIANNA POŚNIEWSKA', age: '44 lata', nationality: 'Polska', knownFor: 'Aktorka' },
  { name: 'ARKADIUSZ MILIK', age: '30 lat', nationality: 'Polska', knownFor: 'Piłkarz' },
  { name: 'KACPER URBAN', age: '28 lat', nationality: 'Polska', knownFor: 'Piłkarz' },
  { name: 'SEBASTIAN SZYMAŃSKI', age: '25 lat', nationality: 'Polska', knownFor: 'Piłkarz' },
  { name: 'JAKUB MODER', age: '25 lat', nationality: 'Polska', knownFor: 'Piłkarz' },
  { name: 'KAMIL GLIK', age: '36 lat', nationality: 'Polska', knownFor: 'Piłkarz' },
  { name: 'ŁUKASZ FABIAŃSKI', age: '39 lat', nationality: 'Polska', knownFor: 'Piłkarz' },
  { name: 'PAWEŁ SOCHA', age: '34 lata', nationality: 'Polska', knownFor: 'Piłkarz' },
  { name: 'THIERRY HENRY', age: '47 lat', nationality: 'Francja', knownFor: 'Piłkarz' },
  { name: 'RONALDO NAZÁRIO', age: '48 lat', nationality: 'Brazylia', knownFor: 'Piłkarz' },
  { name: 'PAOLO MALDINI', age: '56 lat', nationality: 'Włochy', knownFor: 'Piłkarz' },
  { name: 'FRANCESCO TOTTI', age: '48 lat', nationality: 'Włochy', knownFor: 'Piłkarz' },
  { name: 'ANDREA PIRLO', age: '45 lat', nationality: 'Włochy', knownFor: 'Piłkarz' },
  { name: 'SERGIO RAMOS', age: '38 lat', nationality: 'Hiszpania', knownFor: 'Piłkarz' },
  { name: 'MANUEL NEUER', age: '38 lat', nationality: 'Niemcy', knownFor: 'Piłkarz' },
  { name: 'TONI KROOS', age: '34 lata', nationality: 'Niemcy', knownFor: 'Piłkarz' },
  { name: 'JOSHUA KIMMICH', age: '29 lat', nationality: 'Niemcy', knownFor: 'Piłkarz' },
  { name: 'KEVIN DE BRUYNE', age: '33 lata', nationality: 'Belgia', knownFor: 'Piłkarz' },
  { name: 'EDEN HAZARD', age: '33 lata', nationality: 'Belgia', knownFor: 'Piłkarz' },
  { name: 'PAUL POGBA', age: '31 lat', nationality: 'Francja', knownFor: 'Piłkarz' },
  { name: 'ANTOINE GRIEZMANN', age: '33 lata', nationality: 'Francja', knownFor: 'Piłkarz' },
  { name: 'KARIM BENZEMA', age: '37 lat', nationality: 'Francja', knownFor: 'Piłkarz' },
  { name: 'ROBERTO CARLOS', age: '51 lat', nationality: 'Brazylia', knownFor: 'Piłkarz' },
  { name: 'RIVALDO', age: '52 lata', nationality: 'Brazylia', knownFor: 'Piłkarz' },
  { name: 'KAKA', age: '42 lata', nationality: 'Brazylia', knownFor: 'Piłkarz' },
  { name: 'CARLOS TEVEZ', age: '40 lat', nationality: 'Argentyna', knownFor: 'Piłkarz' },
  { name: 'GABRIEL BATISTUTA', age: '55 lat', nationality: 'Argentyna', knownFor: 'Piłkarz' },
  { name: 'SERGIO AGÜERO', age: '36 lat', nationality: 'Argentyna', knownFor: 'Piłkarz' },
  { name: 'PAUL SCHOLES', age: '50 lat', nationality: 'Anglia', knownFor: 'Piłkarz' },
  { name: 'STEVEN GERRARD', age: '44 lata', nationality: 'Anglia', knownFor: 'Piłkarz' },
  { name: 'FRANK LAMPARD', age: '46 lat', nationality: 'Anglia', knownFor: 'Piłkarz' },
  { name: 'WAYNE ROONEY', age: '39 lat', nationality: 'Anglia', knownFor: 'Piłkarz' },
  { name: 'ERIC CANTONA', age: '58 lat', nationality: 'Francja', knownFor: 'Piłkarz' },
  { name: 'GEORGE BEST', age: '1946–2005', nationality: 'Irlandia Północna', knownFor: 'Piłkarz' },
  { name: 'JOHAN CRUYFF', age: '1947–2016', nationality: 'Holandia', knownFor: 'Piłkarz' },
  { name: 'MARCO VAN BASTEN', age: '60 lat', nationality: 'Holandia', knownFor: 'Piłkarz' },
  { name: 'RUUD GULLIT', age: '62 lata', nationality: 'Holandia', knownFor: 'Piłkarz' },
  { name: 'OLIVER KAHN', age: '55 lat', nationality: 'Niemcy', knownFor: 'Piłkarz' },
  { name: 'GIANLUIGI BUFFON', age: '46 lat', nationality: 'Włochy', knownFor: 'Bramkarz' },
  { name: 'SHAQUILLE O\'NEAL', age: '52 lata', nationality: 'USA', knownFor: 'Koszykarz' },
  { name: 'LEBRON JAMES', age: '39 lat', nationality: 'USA', knownFor: 'Koszykarz' },
  { name: 'STEPHEN CURRY', age: '36 lat', nationality: 'USA', knownFor: 'Koszykarz' },
  { name: 'GIANNIS ANTETOKOUNMPO', age: '29 lat', nationality: 'Grecja', knownFor: 'Koszykarz' },
  { name: 'CARLOS ALCARAZ', age: '21 lat', nationality: 'Hiszpania', knownFor: 'Tenisista' },
  { name: 'JANNIK SINNER', age: '23 lata', nationality: 'Włochy', knownFor: 'Tenisista' },
  { name: 'COCO GAUFF', age: '20 lat', nationality: 'USA', knownFor: 'Tenisistka' },
  { name: 'NAOMI OSAKA', age: '27 lat', nationality: 'Japonia', knownFor: 'Tenisistka' },
  { name: 'MARTINA NAVRÁTILOVÁ', age: '68 lat', nationality: 'Czechy', knownFor: 'Tenisistka' },
  { name: 'PETE SAMPRAS', age: '53 lata', nationality: 'USA', knownFor: 'Tenisista' },
  { name: 'ANDRE AGASSI', age: '54 lata', nationality: 'USA', knownFor: 'Tenisista' },
  { name: 'VALENTINO ROSSI', age: '45 lat', nationality: 'Włochy', knownFor: 'Motocyklista' },
  { name: 'MARC MÁRQUEZ', age: '31 lat', nationality: 'Hiszpania', knownFor: 'Motocyklista' },
  { name: 'SEBASTIAN VETTEL', age: '37 lat', nationality: 'Niemcy', knownFor: 'Kierowca F1' },
  { name: 'KIMI RÄIKKÖNEN', age: '45 lat', nationality: 'Finlandia', knownFor: 'Kierowca F1' },
  { name: 'AYRTON SENNA', age: '1960–1994', nationality: 'Brazylia', knownFor: 'Kierowca F1' },
  { name: 'NICO ROSBERG', age: '39 lat', nationality: 'Niemcy', knownFor: 'Kierowca F1' },
  { name: 'CHARLES LECLERC', age: '27 lat', nationality: 'Monako', knownFor: 'Kierowca F1' },
  { name: 'LANDO NORRIS', age: '24 lata', nationality: 'Wielka Brytania', knownFor: 'Kierowca F1' },
  { name: 'GEORGE RUSSELL', age: '26 lat', nationality: 'Wielka Brytania', knownFor: 'Kierowca F1' },
  { name: 'ALEXANDER VOLKANOVSKI', age: '35 lat', nationality: 'Australia', knownFor: 'Zawodnik MMA' },
  { name: 'ISRAEL ADESANYA', age: '35 lat', nationality: 'Nigeria', knownFor: 'Zawodnik MMA' },
  { name: 'KAMARU USMAN', age: '37 lat', nationality: 'Nigeria', knownFor: 'Zawodnik MMA' },
  { name: 'FLOYD MAYWEATHER', age: '47 lat', nationality: 'USA', knownFor: 'Bokser' },
  { name: 'CANEL ÁLVAREZ', age: '34 lata', nationality: 'Meksyk', knownFor: 'Bokser' },
  { name: 'WLADIMIR KLITSCHKO', age: '48 lat', nationality: 'Ukraina', knownFor: 'Bokser' },
  { name: 'VITALI KLITSCHKO', age: '53 lata', nationality: 'Ukraina', knownFor: 'Bokser' },
  { name: 'AL PACINO', age: '84 lata', nationality: 'USA', knownFor: 'Aktor' },
  { name: 'MARLON BRANDO', age: '1924–2004', nationality: 'USA', knownFor: 'Aktor' },
  { name: 'JAMES DEAN', age: '1931–1955', nationality: 'USA', knownFor: 'Aktor' },
  { name: 'CLINT EASTWOOD', age: '94 lata', nationality: 'USA', knownFor: 'Aktor' },
  { name: 'SYLVESTER STALLONE', age: '78 lat', nationality: 'USA', knownFor: 'Aktor' },
  { name: 'BRUCE WILLIS', age: '69 lat', nationality: 'USA', knownFor: 'Aktor' },
  { name: 'DENZEL WASHINGTON', age: '69 lat', nationality: 'USA', knownFor: 'Aktor' },
  { name: 'HEATH LEDGER', age: '1979–2008', nationality: 'Australia', knownFor: 'Aktor' },
  { name: 'JOAQUIN PHOENIX', age: '50 lat', nationality: 'USA', knownFor: 'Aktor' },
  { name: 'CHRISTIAN BALE', age: '50 lat', nationality: 'Wielka Brytania', knownFor: 'Aktor' },
  { name: 'MATT DAMON', age: '54 lata', nationality: 'USA', knownFor: 'Aktor' },
  { name: 'BEN AFFLECK', age: '52 lata', nationality: 'USA', knownFor: 'Aktor' },
  { name: 'GEORGE CLOONEY', age: '63 lata', nationality: 'USA', knownFor: 'Aktor' },
  { name: 'MATTHEW MCCONAUGHEY', age: '55 lat', nationality: 'USA', knownFor: 'Aktor' },
  { name: 'BRADLEY COOPER', age: '49 lat', nationality: 'USA', knownFor: 'Aktor' },
  { name: 'ANNE HATHAWAY', age: '42 lata', nationality: 'USA', knownFor: 'Aktorka' },
  { name: 'SANDRA BULLOCK', age: '60 lat', nationality: 'USA', knownFor: 'Aktorka' },
  { name: 'EMMA STONE', age: '35 lat', nationality: 'USA', knownFor: 'Aktorka' },
  { name: 'JENNIFER ANISTON', age: '55 lat', nationality: 'USA', knownFor: 'Aktorka' },
  { name: 'SALMA HAYEK', age: '58 lat', nationality: 'Meksyk', knownFor: 'Aktorka' },
  { name: 'PENELOPE CRUZ', age: '50 lat', nationality: 'Hiszpania', knownFor: 'Aktorka' },
  { name: 'MONICA BELLUCCI', age: '60 lat', nationality: 'Włochy', knownFor: 'Aktorka' },
  { name: 'SOPHIE MARCEAU', age: '58 lat', nationality: 'Francja', knownFor: 'Aktorka' },
  { name: 'HUGH JACKMAN', age: '56 lat', nationality: 'Australia', knownFor: 'Aktor' },
  { name: 'IAN MCKELLEN', age: '85 lat', nationality: 'Wielka Brytania', knownFor: 'Aktor' },
  { name: 'PATRICK STEWART', age: '84 lata', nationality: 'Wielka Brytania', knownFor: 'Aktor' },
